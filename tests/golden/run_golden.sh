...
python3 scripts/zentable_render.py tests/golden/input.json tests/golden/tmp/out_css.png --force-css --theme-name minimal_ios --width 710 --no-auto-width >/tmp/golden_css_run.log 2>&1
