...
def measure_dom_scroll_width(html: str, html_dir: str, viewport_width: int, viewport_height: int):
    return css_chrome.measure_dom_scroll_width(html, html_dir, viewport_width, viewport_height, TRANSPARENT_BG_HEX)

def measure_dom_overflow(html: str, html_dir: str, viewport_width: int, viewport_height: int):
    return css_chrome.measure_dom_overflow(html, html_dir, viewport_width, viewport_height, TRANSPARENT_BG_HEX)
