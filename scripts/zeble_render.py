...
# PIL font helpers delegate to extracted module (wave4-b4)
FONT_CJK = pil_font.FONT_CJK
FONT_CJK_LIST = pil_font.FONT_CJK_LIST
FONT_EMOJI_LIST = pil_font.FONT_EMOJI_LIST
...
def _detect_emoji_font():
    return pil_font._detect_emoji_font()


def get_font_emoji(size=16):
    return pil_font.get_font_emoji(size)


def is_color_emoji_font():
    return pil_font.is_color_emoji_font()


def get_font(size=16):
    return pil_font.get_font(size)
