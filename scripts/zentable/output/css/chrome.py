#!/usr/bin/env python3
"""Chrome availability + DOM measurement helpers for CSS rendering."""
...
def measure_dom_overflow(
    html: str,
    html_dir: str,
    viewport_width: int,
    viewport_height: int,
    transparent_bg_hex: str = "00000000",
) -> Optional[dict]:
    """Measure DOM overflow for table/body using headless Chrome + --dump-dom."""
    try:
